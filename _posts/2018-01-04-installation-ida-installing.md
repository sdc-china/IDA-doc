...
## Firefox plugin
- Download Firefox plugin [ida-21.1.0-fx.xpi](https://github.com/sdc-china/IDA-plugin/blob/master/firefox/ida-21.1.0-fx.xpi)
- Drag the "ida-21.1.0-fx.xpi" file into firefox window.
- Click "Add" button.
