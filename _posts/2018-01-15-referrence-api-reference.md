...
* BPM   
  ...
  | loginBPMoC                  	 |                                    |  Login into the bpm on cloud  
...
* UI  
  ...
  | bpmFileDropzone                  |  value: the value of the bpm file<br>control ID: the control id of bpm file drop zone<br>Default value: the value of default | bpmFileDropzone                                   | 
