...
#### Firefox
- Download firefox plugin [ida-1.30-fx.xpi](https://github.com/sdc-china/IDA-plugin/raw/master/firefox/ida-1.30-fx.xpi)
- Drag the "ida-1.30-fx.xpi" file into firefox window
- Click "Add" button
