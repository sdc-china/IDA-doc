...
### Create a test project
  ...
  2. Fill in the project form according to the following table.
     ...
     **Notes:**     
     ...
     If the permission control of your Workflow server is controlled by the UMS server, please add your UMS Admin user into ida and set it as UMS Admin user.[Refer to][3]
